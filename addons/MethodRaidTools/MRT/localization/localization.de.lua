...
PH.raidcheckflaskchatTooltip = "Jeder kann diese Schaltfläche anklicken, aber nur der Schlachtzugsleiter oder Assistent kann das Ergebnis im Chat veröffentlichen."
PH.raidcheckslak = "Essens- und Fläschchenbericht beim Readycheck"
PH.raidcheckslakTooltip = "Nur der Anführer kann im Chat berichten."
