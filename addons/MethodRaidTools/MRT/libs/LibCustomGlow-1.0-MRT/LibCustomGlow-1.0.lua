local MAJOR_VERSION = "LibCustomGlow-1.0-MRT"
...
local texturePath = [[Interface\AddOns\MRT\libs\LibCustomGlow-1.0-MRT\]]
local textureList = {
  ["white"] = [[Interface\Buttons\WHITE8X8]],
  ["shine"] = texturePath .. [[artifacts]],
  ["iconalert"] = texturePath .. [[IconAlert]],
  ["iconalertants"] = texturePath .. [[IconAlertAnts]],
}
...
local function configureButtonGlow(f, alpha)
  ...
  f.spark:SetAlpha(0)
  f.spark:SetTexture(textureList["iconalert"])
  ...
  f.innerGlow:SetTexture(textureList["iconalert"])
  ...
  f.innerGlowOver:SetTexture(textureList["iconalert"])
  ...
  f.outerGlow:SetTexture(textureList["iconalert"])
  ...
  f.outerGlowOver:SetTexture(textureList["iconalert"])
  ...
  f.ants:SetAlpha(0)
  f.ants:SetTexture(textureList["iconalertants"])
...
lib.ProcGlow_Start = function() end
lib.ProcGlow_Stop  = function() end
